...
const Dashboard = () => {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {      let image_url = form.image_url;
        if (imageFile) {
        try {
  ...
  }, [session?.user?.id, form, imageFile, editVenue, handleCloseModal, fetchVenues]);
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="fl-ro-ce-ce min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
              ...
              <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full fixed" style={{left: "50%", zIndex: "60", transform:"translateX(-50%)"}}>
