        ...
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-100 to-white py-12 px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Admin/Seller Card */}
              <div 
                onClick={() => !transitionLoading && handleAccountTypeSelect('admin')}
              ...
              >
                <div className="text-center mb-4">
                  ...
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">Seller Account</h2>
              ...
              {/* User Card */}
              <div 
                onClick={() => !transitionLoading && handleAccountTypeSelect('user')}
                className={`bg-white rounded-xl shadow-lg p-6 border border-indigo-100 transition-all duration-300 ${
                  transitionLoading ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-xl cursor-pointer'
                }`}
              >
                <div className="text-center mb-4">
                  ...
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">User Account</h2>
